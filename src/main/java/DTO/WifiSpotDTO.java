...
public class WifiSpot {
	private String ID;
	private String X_SWIFI_MGR_NO; // 와이파이 관리 번호
	private String X_SWIFI_WRDOFC; // 구역 이름
	private String X_SWIFI_MAIN_NM; // 와이파이의 주 이름
	private String X_SWIFI_ADRES1; // 주소 1
	private String X_SWIFI_ADRES2; // 주소 2
	private String X_SWIFI_INSTL_FLOOR; // 설치
	private String X_SWIFI_INSTL_TY; // 설치 유형
	private String X_SWIFI_INSTL_MBY; // 설치 기관
	private String X_SWIFI_SVC_SE; // 서비스 유형
	private String X_SWIFI_CMCWR; // 망 정보
	private String X_SWIFI_CNSTC_YEAR; // 설치 연도
	private String X_SWIFI_INOUT_DOOR; // 실내/실외 여부
	private String X_SWIFI_REMARS3; // 비고
	private String LAT; // 위도
	private String LNT; // 경도
	private String WORK_DTTM; // 작업 일시
